...
async function main() {
  ...
  const products = [
    {
      name: "AeroFlex Performance Hoodie", slug: "aeroflex-performance-hoodie",
      description: "Advanced 4-way stretch fabric with ThermoShield technology. Engineered for peak performance.",
      price: 3499, comparePrice: 4399,
      images: ["https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&q=80"],
      categoryId: men.id, sizes: ["XS","S","M","L","XL","XXL"],
      colors: [{ name:"Black",hex:"#1a1a1a"},{ name:"Red",hex:"#ef4444"},{ name:"White",hex:"#ffffff"}],
      stock: 50, isBestseller: true, isNewArrival: false, isFeatured: true,
      tags: ["hoodie","men","performance","aeroflex"],
    },
    {
      name: "Raglan T", slug: "raglan-t",
      description: "4-Way Stretch. Odour Resistant. Ultra-breathable performance tee for intense workouts.",
    ...
    {
      name: "Summit Training Tee", slug: "summit-training-tee",
      ...
      tags: ["tee","men","performance","summit"],
    },
    {
      name: "Lightweight Short", slug: "lightweight-short",
      ...
      categoryId: men.id, sizes: ["S","M","L","XL","XXL"],
    ...
    {
      name: "Performance Short", slug: "performance-short",
    ...
    {
      name: "Oversize Tee", slug: "oversize-tee",
    ...
    {
      name: "Muscle Tank", slug: "muscle-tank",
      description: "Natural Fiber. Relaxed Fit. Breathable muscle tank for intense training.",
    ...
    {
      name: "Quarter Zip LS", slug: "quarter-zip-ls",
    ...
    {
      name: "Tech Hoodie", slug: "tech-hoodie",
    ...
    {
      name: "Performance Pant", slug: "performance-pant",
    ...
    {
      name: "ThermoShield Training Jacket", slug: "thermoshield-training-jacket",
      description: "ThermoShield insulation keeps you warm during cold-weather training. Lightweight, packable design.",
    ...
    {
      name: "Apex Compression Joggers", slug: "apex-compression-joggers",
    ...
    {
      name: "Compression Tee", slug: "compression-tee",
    ...
    {
      name: "Compression Shorts", slug: "compression-shorts",
    ...
    {
      name: "FlexForm Sports Bra", slug: "flexform-sports-bra",
      ...
      categoryId: women.id, sizes: ["XS","S","M","L","XL"],
      colors: [{ name:"Black",hex:"#1a1a1a"},{ name:"White",hex:"#ffffff"},{ name:"Red",hex:"#ef4444"}],
      stock: 45, isBestseller: false, isNewArrival: true, isFeatured: true,
      tags: ["sports-bra","women","yoga"],
    },
    {
      name: "Sculpt High-Waist Leggings", slug: "sculpt-high-waist-leggings",
    ...
    {
      name: "PowerLift Training Gloves", slug: "powerlift-training-gloves",
      ...
      categoryId: accessories.id, sizes: ["S","M","L","XL"],
  ...
  for (const p of products) {
    await prisma.product.upsert({
      where: { slug: p.slug },
      update: { price: p.price, comparePrice: p.comparePrice, stock: p.stock,
      ...
      create: {
        ...
        sizes: p.sizes, colors: p.colors, stock: p.stock,
        isBestseller: p.isBestseller, isNewArrival: p.isNewArrival,
        isFeatured: p.isFeatured, tags: p.tags,
      },
    });
    count++;
    process.stdout.write(`  ${count}/${products.length} — ${p.name}\n`);
  }
