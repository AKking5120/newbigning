...
export default function InventoryPage() {
  ...
  function getStockStatus(stock: number) {
    if (stock === 0)  return { label: "Out of Stock", bg: "bg-red-50",    text: "text-red-700",    icon: AlertTriangle };
    if (stock <= 10)  return { label: "Low Stock",    bg: "bg-amber-50",  text: "text-amber-700",  icon: AlertTriangle };
    return              { label: "In Stock",      bg: "bg-green-50",  text: "text-green-700",  icon: CheckCircle  };
  }
